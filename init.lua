...
require('lazy').setup({
  ...
  -- after the plugin has been loaded as `require(MODULE).setup(opts)`.
  {
    ...
    opts = {
      -- You can customize keywords here, but the defaults are great.
  ...
  { -- Highlight, edit, and navigate code
    ...
    opts = {
      ensure_installed = { 'python', 'cpp', 'bash', 'c', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'query', 'vim', 'vimdoc' },
      -- Autoinstall languages that are not installed
      auto_install = true,
      highlight = {
        enable = true,
        disable = { 'markdown', 'markdown_inline' }, -- Prevents CopilotChat markdown crashing tree-sitter globally
